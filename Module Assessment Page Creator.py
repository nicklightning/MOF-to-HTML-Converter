# -*- coding: utf-8 -*-
"""
Module Assessment Page Creator Script
@author: nnrw

This script automates the creation of HTML pages about Assessment Information. The HTML can be manually dropped into Canvas Pages if desired. 
"""
