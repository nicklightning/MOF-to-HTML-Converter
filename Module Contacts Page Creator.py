# -*- coding: utf-8 -*-
"""
Module Contacts Page Creator Script
@author: nnrw

This script automates the creation of HTML pages about Module Contacts. The HTML can be manually dropped into Canvas Pages if desired. 
"""
